...
At Functionary, we work with Figma and the [figmagic project](https://github.com/mikaelvesavuori/figmagic), allowing to extract specific values from a Figma document.
